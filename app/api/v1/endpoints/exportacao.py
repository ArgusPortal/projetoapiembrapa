...
async def get_exportacao(
    ...
    produto: Optional[str] = Query(None, description="Tipo de produto (vinhos_mesa, espumantes, uvas_frescas, sucos)"),
    destino: Optional[str] = Query(None, description="País/região de destino"),
